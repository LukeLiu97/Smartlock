...
#define RFID_GPIO GPIOA

#define RFID_CSH RFID_GPIO->ODR |= 1 << RFID_CS_PIN
#define RFID_RSTH RFID_GPIO->ODR |= 1 << RFID_RST_PIN

#define RFID_CSL RFID_GPIO->ODR &= ~(1 << RFID_CS_PIN)
#define RFID_RSTL RFID_GPIO->ODR &= ~(1 << RFID_RST_PIN)

// ------
#define RFID_CS_H() (GPIO_SetBits(GPIOA, GPIO_Pin_6))
#define RFID_CS_L() (GPIO_ResetBits(GPIOA, GPIO_Pin_6))
#define RFID_RST_H() (GPIO_SetBits(GPIOA, GPIO_Pin_7))
#define RFID_RST_L() (GPIO_ResetBits(GPIOA, GPIO_Pin_7))
